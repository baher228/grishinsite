...
export const sampleProducts: Product[] = [
  {
    ...
    category: "tools",
    description:
      "High-performance cordless drill with 18V battery and complete bit set.",
    stock: 10,
    rating: 4.5,
    reviews: 128,
  },
  {
    ...
    category: "tools",
    description:
      "Professional grade adjustable wrench set with chrome vanadium steel construction.",
    stock: 10,
    rating: 4.7,
    reviews: 89,
  },
  {
    ...
    category: "plumbing",
    description:
      "Complete copper pipe fitting kit with elbows, tees, and couplings.",
    stock: 10,
    rating: 4.3,
    reviews: 67,
  },
  {
    ...
    description:
      "Professional 16oz steel hammer with ergonomic grip and balanced design.",
    stock: 10,
    rating: 4.6,
    reviews: 156,
  },
  {
    ...
    category: "plumbing",
    description:
      "Heavy-duty PVC pipe cutter for pipes up to 2 inches in diameter.",
    stock: 10,
    rating: 4.4,
    reviews: 92,
  },
  {
    ...
    category: "tools",
    description:
      'Professional circular saw with 7.25" carbide blade and laser guide.',
    stock: 10,
    rating: 4.8,
    reviews: 203,
  },
  {
    ...
    category: "plumbing",
    description:
      "Complete toilet flange repair kit with wax ring and mounting hardware.",
    stock: 10,
    rating: 4.2,
    reviews: 45,
  },
  {
    ...
    category: "construction",
    description:
      "Professional 48-inch level with magnetic base and high-visibility vials.",
    stock: 10,
    rating: 4.5,
    reviews: 112,
  },
  ...
  },
  {
    ...
    category: "plumbing",
    description:
      "25-foot drain snake with rotating handle for clearing tough clogs.",
    stock: 10,
    rating: 4.2,
    reviews: 73,
  },
  {
    ...
    category: "construction",
    description:
      "ANSI certified safety helmet with adjustable suspension and chin strap.",
    stock: 10,
    rating: 4.5,
    reviews: 78,
  },
  {
    ...
    category: "tools",
    description:
      "Complete 42-piece socket wrench set with ratcheting handle and extension bars.",
    stock: 10,
    rating: 4.6,
    reviews: 145,
  },
